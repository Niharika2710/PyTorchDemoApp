...
import org.pytorch.demo.vision.view.CovidSafeActivity;
import org.pytorch.demo.vision.view.DemoCameraActivity;
...
public class VisionListActivity extends AbstractListActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.vision_card_covid_safe).setOnClickListener(v -> {
    Intent intent = new Intent(VisionListActivity.this, CovidSafeActivity.class);
     // Intent intent = new Intent(VisionListActivity.this, DemoCameraActivity.class);
     // intent.putExtra(ImageClassificationActivity.INTENT_MODULE_ASSET_NAME, "resnet18.pt");
     // intent.putExtra(ImageClassificationActivity.INTENT_INFO_VIEW_TYPE,
      //        InfoViewFactory.INFO_VIEW_TYPE_IMAGE_CLASSIFICATION_RESNET);
      startActivity(intent);
